...
import 'package:su_kien_tot/pages/cashout/cashout_page.dart';
...
class AppRouter {
  static final GoRouter router = GoRouter(
    ...
    routes: <RouteBase>[
      ...
      GoRoute(path: '/introduction1', builder: (context, state) => const Introduction1()),
      GoRoute(path: '/introduction2', builder: (context, state) => const Introduction2()),
      ...
      GoRoute(path: '/transaction-page', builder: (context, state) => const TransactionPage()),
      GoRoute(path: '/payment-page', builder: (context, state) => const PaymentPage()),
      GoRoute(path: '/voucher-page', builder: (context, state) => const VoucherPage()),
      GoRoute(path: '/favorite-page', builder: (context, state) => const FavoritePage()),
      GoRoute(path: '/setting-page', builder: (context, state) => const SettingPage()),
      GoRoute(path: '/language-page', builder: (context, state) => const LanguagePage()),
      GoRoute(path: '/link-account-page', builder: (context, state) => const LinkAccountPage()),
      GoRoute(path: '/help-page', builder: (context, state) => const HelpPage()),
      GoRoute(path: '/profile-page', builder: (context, state) => const ProfilePage()),
      GoRoute(path: '/guide-page', builder: (context, state) => const GuidePage()),
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          return ImagePreview(title: title, imagePath: imagePath, next: next, isConfirm: isConfirm);
        },
      ),
      ...
      StatefulShellRoute.indexedStack(
        ...
        branches: [
          StatefulShellBranch(
            routes: [GoRoute(path: '/home-user', builder: (context, state) => const HomeUser())],
          ),
          StatefulShellBranch(
            routes: [GoRoute(path: '/activity', builder: (context, state) => const ActivityPage())],
          ),
          StatefulShellBranch(
            routes: [GoRoute(path: '/chat-page', builder: (context, state) => const ChatPage())],
          ),
          StatefulShellBranch(
            routes: [GoRoute(path: '/notification', builder: (context, state) => const NotificationPage())],
          ),
          StatefulShellBranch(
